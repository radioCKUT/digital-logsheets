...
if ($same_episode == 0){
	...
	mysql_query("INSERT INTO episode VALUES ($max_id, $max_playlist, $program, '$programmer', 1, '$start_datetime', '$end_datetime', $prerecord, '$prerecord_date', 1, '$notes')") or die(mysql_error());
	echo $max_id;
} else {
