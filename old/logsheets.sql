...
INSERT INTO `program` VALUES (1,'lo signal',NULL,NULL);
...
CREATE TABLE `segment` (
  ...
  `can_con` tinyint(1) DEFAULT NULL,
  `new_release` tinyint(1) DEFAULT NULL,
  `french_vocal_music` tinyint(1) DEFAULT NULL,
...
-- Dump completed on 2015-05-04  3:03:24
